...
* 年齢は実は<u decoration-wavy>幸福度に一番関係している要素</u>
...
否定的な見方(ステレオタイプ)を持っている人もいるかも知れません
</div>
...
注: これは健康・人間関係など他の成分を抜いて年齢成分だけを残した後の話
</div>
...
<div v-click=2>
<u>平均的に見れば</u><span data-id="male">男性は40代</span>、<span data-id="female">女性は60代</span>に幸福度の最低点を取る。
</div>
...
* 悲しみや怒りといった否定的な感情は、年齢とともにより穏やかで頻度の<br>低いものになる
  * 扁桃体(脳の感情処理センター)が反応性低下が、特に否定的な感情刺激に対する反応性を弱める
...
「加齢に対する否定的なステレオタイプ」（例：高齢者は弱く病気がち）を持つと、自己肯定感が低下したり健康行動が阻害されたりして、最終的に寿命を縮める可能性がある。Levy, B. (2009)
...
一般的な「高齢者」に対して否定的な見解を持つ人々が、より長生きする傾向にあった。
...
* 「高い不安、自己不信、うつ病、そして実存的な不安」が伴うことが多い
  * **過去の未解決の問題**や、**くすぶっていた衝動**を行動に移したいという欲求
...
* 「弱い高齢者になりたくない」という気持ちが健康にポジティブに働くという研究もあるが、いつかは高齢者になるので、受け入れる気持ちも大事
