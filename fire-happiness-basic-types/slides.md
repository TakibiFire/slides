...
「あなたの脳は変えられる」の本では、<br>**持続的で深い満足感**を目指すべきと説きます。

それは、外的な要因に左右されず、**自分の内側から湧き出る、**
<br>穏やかで満たされた状態のことです。
...
# 快楽や興奮があんまり良くなさそう<br>という雰囲気は分かるけど、<br>目標達成とか他人から認めてもらう<br>ことは良いことじゃないの？

<div text-8 text-red>

<carbon-ArrowRight/> あなたは満足しますが、その満足は持続しません。
<div ml-11>後々解説します。</div>
