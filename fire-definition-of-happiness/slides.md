...
* 「幸福を定義する」こと自体が難しいことを知ろう
  * めちゃくちゃ色々な要素が絡んでいる
  * このスライドを読んで分かった気になったら危険。「あぁ難しいんだな」と分かってもらえれば嬉しいです。
* 幸福よりもウェルビーイングを目指すことが主流
  * 幸福は最近の気持ちに左右されやすい
...
* とりあえず色々な幸福の計り方を紹介します
  ...
  * 研究の興味の対象ごとに、それにあった指標を使っている感じ
* **「あ〜こういう要素が関係しているんだね〜」<span text-red>「あれもこれも考えなくちゃいけないんだね〜」</span>「幸福って難しいんだね〜」という感想を持ってもらえるだけで十分です** <carbon-ArrowLeft/> このスライドのゴール
  * これがわかれば「幸福の秘訣は〇〇だ！」みたいな話はウソ、というか数ある<br>側面の1つしか対象にしていないことが分かってもらえると思います。
  * <u decoration-wavy decoration-orange>「FIRE後幸福に生きるためには」を解説するのに、厳密な計り方を詳しく知る必要はありません</u>
...
良い感情をより多く、悪い感情をより少なく体験し、自分の生活に満足していることが、幸福の指標とした
...
* 人生満足度は「何かを得た幸せ（獲得的幸福）」を表して、短期的満足にフォーカスしている
...
「自分の真の可能性の方向へ合致した行動をしているという感覚」を表す6指標 (ユーダイモニア的幸福とも呼ばれる)。[日本語版の質問一覧をみたい人はこちら (pdf)](https://mhpn.m.u-tokyo.ac.jp/wp/wp-content/uploads/2023/10/PWB-42.pdf)
...
# 協調的幸福感 (Hitokoto, 2015)

* 日本人は社会的調和と幸福を結び付ける傾向がある。
  * 例: 自分の幸福は他の人の幸福に依存しており、他の人の幸福は自分の幸福にとって重要

協調的幸福感を計るために作られた9個の質問のうち5個を掲載。全部みたい人は[論文](https://www.researchgate.net/publication/260061708_Interdependent_Happiness_Theoretical_Importance_and_Measurement_Validity)へ。
...
**結論:<br>「どれもお互い関連し合って<br>いる。どれも重要」**
</div>
<div col-span-7>
...
* RPGでレベルが上がると全部のステータスが上がっていくような感じ
...
* 幸福度は、主に遺伝と人生の初期に私たちに根付いた性格特性によって決定されるという説
...
衝撃的で流行ったが、数々の誤解を生んだ。
<span text-red>遺伝の要素は30%くらいだということも分かってきた。</span>
...
<div v-click=2 mx-auto text-5.5
...
Happiness (幸福)とは
* 残念ながら使われる場所、研究者によって意味が変わる
  * 日常会話では「ポジティブな感情、心の状態」
  * これは主観的ウェルビーイングの一部
* **文脈によっては主観的ウェルビーイングと同じ意味**
  * "幸福には人生への深い満足感も含みます" などと言う場合
* **文脈によっては Well-Being と同じ意味で使いがち**
  * Seligman は、研究で "happiness" という言葉を使うのはまぎらわしいしやめようと言っている
...
<span text-red>“Well-Being" を幸福と訳してきた過去があり日本語ではごちゃごちゃになりがち</span>
...
（有酸素、無酸素運動、食事、生活習慣）</div>
  <div class="mid"><carbon-ArrowsHorizontal/></div>
  <div class="rgt" v-mark.circle.purple=1>色々なことをしなくてはいけない</div>
</div>
...
<div v-click=2 absolute top-30 left-50 text-8 font-bold data-id="health">健康・みなぎる活力</div>

<FancyArrow v-click=2 animationDelay=500
  from="[data-id=diet]@top" to="[data-id=health]@bottom" width=7 color=blue arc="-0.1" />

<div v-click=3 absolute top-60 left-10 text-8 text-center font-bold data-id="body">引き締まった体<br>(副産物)</div>

<FancyArrow v-click=3 animationDelay=500
  from="[data-id=diet]@(50%,-120%)" to="[data-id=body]@(110%,50%)" width=7 color=red arc="0.1" />

<div v-click=4 absolute top-100 left-145 text-8 text-center font-bold data-id="practice">幸福の<br>トレーニング</div>

<div v-click=5 absolute top-30 left-150 text-8 font-bold data-id="life">良い人生</div>

<FancyArrow v-click=5 animationDelay=500
  from="[data-id=practice]@top" to="[data-id=life]@bottom" width=7 color=blue arc="0.1" />

<div v-click=6 absolute top-60 left-200 text-8 font-bold data-id="happiness">幸福感<br>(副産物)</div>

<FancyArrow v-click=6 animationDelay=500
...
* 幸福のトレーニングをつめば良い人生に向かっていきやすくなり、<br>その途中で幸福度も上がる (「幸福は作れる」)
  * ただし、ダイエットと同じで、色々なことをしないといけないし、し続けないといけない
